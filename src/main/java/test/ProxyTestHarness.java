...
public class ProxyTestHarness {
    ...
    public static void main(String[] args) {
        ...
        Path connectionProfilePath = Paths.get("/Users/liamg/dev/WeTradePOC/common/src/fixtures/connection.json");
        Path walletPath = Paths.get("/Users/liamg/dev/WeTradePOC/common/src/fixtures/wallet");
